...
while(True):
    ...
    if(choice =='1'):
        add_cont.add_contact(load_cont.contacts)
    elif(choice =='2'):
        view_cont.view_contacts(load_cont.contacts)
    elif(choice =='3'):
        search_cont.search_contact(load_cont.contacts)
    elif(choice=='4'):
        remove_cont.remove_contacts(load_cont.contacts)
    elif(choice =='5'):
        print("Thanks for usign this app")
        break
    else:
